...
- **MPL-2.0:** file-level copyleft; modifications to covered files carry obligations.
- **GPL:** strong copyleft generally matters when distributing derivative or combined works; boundary questions can be fact-specific.
- **AGPL:** adds network-interaction/source obligations beyond ordinary GPL distribution scenarios; hosted use needs deliberate review.
...
- **No license:** publicly visible source code is not automatically permission to copy, modify or distribute.

A permissive top-level license does not guarantee all vendored code, assets, models, datasets, fonts, plugins or dependencies have equivalent rights.
