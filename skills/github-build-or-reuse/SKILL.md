...
description: "Search GitHub and open-source projects before substantial implementation; verify fit, license, maintenance, security, governance and adoption cost, then decide USE, CONTRIBUTE, FORK or BUILD. Use for new apps, tools, services, libraries, plugins, substantial features, or requests for open-source alternatives."
license: MIT
...
Return: decision and confidence; requirements and hard gates; 3–6 serious candidates when available; evidence-backed comparison; rejected candidates and why; license/maintenance/security caveats; adoption effort relative to greenfield; and the next action. Never fabricate stars, activity, compatibility, maturity or legal conclusions.
